...
const sections = [
  ...
  },
  {
    ...
    body: "Returns and replacements are accepted within 3 days of delivery only for size-related issues, provided the product is unused, unwashed, and in original packaging. Replacements are subject to stock availability. RTO charges for returns may be deducted from the refund unless the product is defective, damaged, or wrong at delivery. Refunds will be credited to the original payment method within 7-10 business days after return verification.",
  },
  {
